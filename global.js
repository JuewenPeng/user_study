...
var path_submit = 'http://39.101.79.70:20002/'                                                  // 公网 ip
var path = location.href.substring(0,location.href.lastIndexOf('/')) + '/images/COMPRESS/'                // 图片文件路径
...
var numfunc = 4                                                                                 // 方法数量
var testFunc = ['vdslr','deeplens', 'iphone15pro','bokehme']                               // 方法名称
// var testFunc = ['vdslr','sterefo','deeplens','mpib','bokeh','bokehme']                               // 方法名称
// var testFunc = ['VDSLR','SteReFo','DeepLens','iPhone15Pro','BokehMe']                               // 方法名称
var testIDs = [1,2,3,4]    // 方法序号
